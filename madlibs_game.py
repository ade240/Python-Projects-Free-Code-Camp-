...
verb_1 = input("Enter a verb of your choice, and press enter:")
adj_1 = input("Enter an adjective of your choice, and press enter:")
verb_2 = input("Enter second verb of choice, and press enter:")
body_part = input("Enter a body part of your choice, and press enter:")
